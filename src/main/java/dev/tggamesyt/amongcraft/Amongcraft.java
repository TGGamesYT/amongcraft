...
import dev.tggamesyt.amongcraft.mixin.PlayerListS2CPacketAccessor;
...
import static dev.tggamesyt.amongcraft.AmongCraftCommands.getPlayerRole;
import static dev.tggamesyt.amongcraft.AmongCraftCommands.impostors;
import static dev.tggamesyt.amongcraft.MeetingManager.handleVote;
import static dev.tggamesyt.amongcraft.SabotageTaskBlock.generateRandomLightState;
import static dev.tggamesyt.amongcraft.TaskProgressTracker.*;
...
public class Amongcraft implements ModInitializer {
    ...
    private static Block register(String name, Block block) {
        ...
        public void onInitialize() {
            ...
            ServerTickEvents.END_SERVER_TICK.register(server -> dev.tggamesyt.amongcraft.TickScheduler.tick());
                ...
                server.execute(() -> {
                    switch (sabotageType) {
                        case "lights" -> {
                            ...
                            dev.tggamesyt.amongcraft.TickScheduler.schedule(() -> {
