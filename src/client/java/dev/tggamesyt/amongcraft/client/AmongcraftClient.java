...
import dev.tggamesyt.amongcraft.*;
...
import static dev.tggamesyt.amongcraft.Amongcraft.*;
import static dev.tggamesyt.amongcraft.client.ClientCutscenePlayer.playCutscene;
...
public class AmongcraftClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(Amongcraft.OPEN_TASK_PACKET_ID, (client, handler, buf, responseSender) -> {
            ...
            client.execute(() -> {
                dev.tggamesyt.amongcraft.client.tasks.TaskMinigameScreen screen =
                        dev.tggamesyt.amongcraft.client.tasks.TaskScreens.create(taskName, pos);
                if (screen != null) {
        ...
        ClientPlayNetworking.registerGlobalReceiver(dev.tggamesyt.amongcraft.SabotageTaskBlock.OPEN_GUI_PACKET,
                (client, handler, buf, responseSender) -> {
                    BlockPos pos = buf.readBlockPos();
